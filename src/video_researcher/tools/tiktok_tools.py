        ...
        async with TikTokClient(api_key=api_key) as client:
            ...
            for video in result.videos:
                formatted_video = {
                    ...
                    "author": {
                        "username": video.author.unique_id if video.author else "unknown",
                        "nickname": video.author.nickname if video.author else "unknown",
                    ...
                    "music": {
                        ...
                        "duration": video.music_info.duration if video.music_info else 0,
                        "original": video.music_info.original if video.music_info else False
                    },
