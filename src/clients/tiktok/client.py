...
from .models import HashtagInfo, HashtagPostsResponse, PaginatedResult, TikTokAPIResponse, VideoInfo
...
class TikTokClient(BaseAPIClient):
    ...
    async def get_hashtag_info(self, hashtag_name: str) -> Optional[HashtagInfo]:
        ...
        try:
            ...
            print(f"Error parsing hashtag info: {e}")
            return None
    ...
    async def get_hashtag_posts_page(
        ...
        try:
            ...
            print(f"Error parsing hashtag posts: {e}")
            return None
